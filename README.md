 ...
 * ... *a duck?* (Coba relies only on duck-typing so no inheritance is needed to extend coba's built-in functionality)
 ...
 To start using Coba right away we recommend visiting our [documentation](https://coba-docs.readthedocs.io/). In the documentation you can find an API reference, detailed explanations of features, and links to example projects.
