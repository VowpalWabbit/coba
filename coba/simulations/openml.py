...
class OpenmlCsvSource(Source[Tuple[Sequence[Context], Sequence[Action]]]):
...
class OpenmlArffSource(Source[Tuple[Sequence[Context], Sequence[Action]]]): # dict for features
    ...
    def read(self) -> Tuple[Sequence[Sequence[Any]], Sequence[Any]]:
        ...
        from coba.data.filters  import ArffReader
        ...
        try:
            ...
            o_key   = f"http://www.openml.org/data/v1/download/{d_object['file_id']}"
            o_bytes = self._query(o_key, "obser", md5_checksum)
