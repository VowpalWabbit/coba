...
class OpenmlSource_Tests(unittest.TestCase):
    ...
    def test_numeric_action(self):
        ...
        self.assertEqual((1,), label_rows[0])
        self.assertEqual((2,), label_rows[1])
        self.assertEqual((3,), label_rows[2])
        self.assertEqual((4,), label_rows[3])
        self.assertEqual((5,), label_rows[4])
