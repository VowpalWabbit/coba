...
class JsonEncoder_Tests(unittest.TestCase):
    def test_simple_encode(self):
        ...
        expected_json_txt = '{"a": 1, "_types": ["SimpleJsonSerializable"]}'
    ...
    def test_nested_encode(self):
        ...
        actual_json_txt   = CobaJsonEncoder().encode(obj)
        expected_json_txt = '{"a": {"a": 1, "_types": ["SimpleJsonSerializable"]}, "_types": ["SimpleJsonSerializable"]}'
...
class JsonDecoder_Tests(unittest.TestCase):
    ...
    def test_simple_decode(self):
        json_txt = '{"a": 1, "_types": ["SimpleJsonSerializable"]}'
        obj = CobaJsonDecoder().decode(json_txt, [SimpleJsonSerializable])

        self.assertEqual(obj._a, 1)

    def test_nested_decode(self):
        json_txt = '{"a": {"a": 1, "_types": ["SimpleJsonSerializable"]}, "_types": ["SimpleJsonSerializable"]}'
        obj = CobaJsonDecoder().decode(json_txt, [SimpleJsonSerializable])
