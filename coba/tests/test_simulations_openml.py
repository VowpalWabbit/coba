...
from coba.simulations import OpenmlSimulation, OpenmlSource, OpenmlRegressionSource
...
class OpenmlSimulation_Tests(unittest.TestCase):
    ...
    def test_regression_openml(self):
        ...
        feature_rows, label_col = OpenmlRegressionSource(42693).read()

        self.assertEqual(len(feature_rows), 5)
        self.assertEqual(len(label_col), 5)

        self.assertEqual((27, 1410, 1, 1), feature_rows[0])
        self.assertEqual((29, 1180, 1, 1), feature_rows[1])
        self.assertEqual((28, 1410, 1, 0), feature_rows[2])
        self.assertEqual((27, 1020, 0, 0), feature_rows[3])
        self.assertEqual((23, 4700, 0, 0), feature_rows[4])
