...
from coba import Environments, Experiment, RandomLearner, VowpalEpsilonLearner
...
if __name__ == '__main__':
    ...
    Environments.set_cache_directory('./.coba_cache')
    ...
    result.plot_contrast(0, 1, "environment_id", "reward" , mode="scat", err='se', labels=["VWEpsilon","VWBag"])
