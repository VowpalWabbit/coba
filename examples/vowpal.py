...
#define a benchmark
#  the benchmark replays the game 15 times to average 
#  out a solver randomly guessing the right answer early
benchmark = UniversalBenchmark([game]*15, lambda i: 1, 900)
